 ...
 * The class <code>OurLittleRobot</code> is just similar to the class
 * <code>LittleRobot</code> but defines a robot with no energy information
 * and which speed and steering angle are controllable. 
 * The type of speed is integer.
 * 
 * <p><strong>Invariant</strong></p>
 * 
 * <pre>
 * invariant	this.speed >= 0.0 && this.speed <= 40.0
...
@WithSensors
@WithActuators
public class OurLittleRobot		extends Thread
implements Robot
{
	...
	@IntegerSensorData(
			...
			dataRange = @IntegerRange(inf = 0, sup = 40),
			maxReadingRate = 40,
			minReadingRate = 0,
			variation = VariationType.RANDOM
			)
