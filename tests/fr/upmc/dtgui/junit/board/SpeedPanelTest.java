...
public class SpeedPanelTest extends TestCase {
	...
	public void setUp() throws Exception {
		...
		SpeedPanelJavassist.create(pool, littleRobot, littleRobotBoard);
	}
	...
	public void testMakeClassAndMethod() 
		...
		try{
			classFound=false;
			pool.get("fr.upmc.dtgui.tests.LittleRobotTeleoperationBoard$SpeedPanel");
			CtMethod[] methods=pool.get("fr.upmc.dtgui.tests.LittleRobotTeleoperationBoard$SpeedPanel").getMethods();
			for (CtMethod m:methods){
