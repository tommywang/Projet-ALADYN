...
public class RobotSensorDataSenderTest extends TestCase {
	@Override
	public void setUp() throws Exception {
		pool = ClassPool.getDefault();
		littleRobot=pool.get("fr.upmc.dtgui.tests.LittleRobot");
		SensorDataSenderJavassist sds=new SensorDataSenderJavassist();
		sds.create(pool, littleRobot);
	}
	...
	public void testMakeClass() 
			throws Throwable{
		try{
			pool.get("fr.upmc.dtgui.tests.LittleRobot$SensorDataSender");
		}
		catch(Exception e){
			classFound=false;
